package br.com.aws.config.local;
...
public class SnsCreate {
	...
	public SnsCreate() {
		this.snsClient = AmazonSNSClient.builder()
				.withEndpointConfiguration(new AwsClientBuilder.EndpointConfiguration("http://192.168.99.101:4566", Regions.US_EAST_1.getName()))
